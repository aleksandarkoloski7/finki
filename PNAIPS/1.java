...
Во дадената листа потребно е сите јазли коишто содржат String со должина L
да се поместат на крај на листата, задржувајќи го и оригиналниот распоред на елементите.
...
public class Main {
    public static void main(String[] args) {
        ...
        SLLNode<String> dvizi = niza.getFirst();
      
        for(int i = 0;i<N;i++)
        {
            if(dvizi.element.length()==L){
                 SLLNode<String> brisi = dvizi;
                niza.delete(brisi);
                niza.insertLast(brisi.element);
            }
            dvizi=dvizi.succ;
        }
        System.out.println(niza.toString());
